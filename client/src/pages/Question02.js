  ...
  return (
    <>
      ...
      <div className="App container mt-4">
        <h1 style={{ fontSize:'30px', fontWeight:'bold', marginBottom:'1.5rem'}}>මා පිලිබද තොරතුරු</h1>
        <div className='form'>
          <div className="mb-3">
          ...
          <div className="mb-3">
            <label className="form-label">ඔබ ඔබගේ පව්ලේ සාමාජිකයන් සමග සිටින පින්තූරයක් ඇතුලත් කරන්න</label>
