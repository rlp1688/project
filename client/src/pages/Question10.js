  ...
  return (
    <>
      ...
      <div className="App container mt-4">
        <h1 style={{ fontSize:'30px', fontWeight:'bold', marginBottom:'1.5rem'}}>මාගේ ක්‍රීඩා ජයග්‍රහණය</h1>
        <div className='form'>
          <div className="mb-3">
          ...
          <div className="mb-3">
            <label className="form-label">ඔබ සහභාගි වූ ක්‍රීඩා අවස්ථාවක පිංතූරයක් ඇතුලත් කරන්න</label>
