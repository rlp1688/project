  ...
  return (
    <>
      ...
      <div className="App container mt-4">
        <h1 style={{ fontSize:'30px', fontWeight:'bold', marginBottom:'1.5rem'}}>පාසල් නිල ඇදුම සමග පිංතූරය</h1>
        <div className='form'>
          <div className="mb-3">
          ...
          <div className="mb-3">
            <label className="form-label">පාසල් නිල ඇදුම සමග පිංතූරයක් ඇතුලත් කරන්න</label>
