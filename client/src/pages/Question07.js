...
export default function Question07() {
  ...
  return (
    <>
      ...
      <div className="App container mt-4">
        <h1 style={{ fontSize:'30px', fontWeight:'bold', marginBottom:'1.5rem'}}>මා ගිය චාරිකා</h1>
        <div className='form'>
          <div className="mb-3">
          ...
          <div className="mb-3">
            <label className="form-label">ඔබ ගිය අධ්‍යාපන, විනෝද සහ වන්දනා ගමන් වල පිංතූර ඇතුලත් කරන්න</label>
