...
export default function Question06() {
  ...
  return (
    <>
      ...
      <div className="App container mt-4">
        <h1 style={{ fontSize:'30px', fontWeight:'bold', marginBottom:'1.5rem'}}>අ.පො.ස සා පෙල සමත් වීමට බාහිර ක්‍රියාකාරකම් සහ වැඩ පොත සම්පූර්ණ කිර්‍ර්ම</h1>
        <div className='form'>
          <div className="mb-3">
          ...
          <div className="mb-3">
            <label className="form-label">ඔබගේ ජීවිතයේ විශේෂ මතකයක පිංතූරයක් ඇතුලත් කරන්න</label>
